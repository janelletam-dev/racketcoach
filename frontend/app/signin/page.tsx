    ...
    <main className="flex-1 flex flex-col items-center justify-center px-6 py-16">
      <div className="w-full max-w-md flex flex-col items-center gap-8">
        ...
        <Card className="w-full">
          ...
          {sent ? (
            <p className="text-rc-ink text-sm mb-2">
              Sign-in link sent. Check your email, or in development the backend
              console prints the link.
            </p>
          ) : (
          ...
          {isDev ? (
            <div className="mt-6 pt-5 border-t-2 border-dashed border-rc-line">
              ...
              <p className="text-rc-muted text-xs mt-2">
                In development the magic link is printed to the backend console,
